...
const AbilityCard = forwardRef<HTMLDivElement, AbilityCardProps>(
    (
        { name, /* image, */ onClick, className = "", cost = 0, keybind },
        ref,
    ) => {
        return (
            <GlareHover>
                ...
                >
                    <Plate
                        ...
                        pathDataTemplate="M 8 0 H width-L1 h 56 l 8 8 V height-L1 v 56 l -8 8 H ts h -56 l -8 -8 V 8 l 8 -8 Z"
                    >
                        <div className="flex items-center justify-center min-h-15">
                            ...
                            {/* </div> */}
                            <div className="pl-2 flex-1 text-lg text-[#E8D8A1] flex items-center justify-between gap-4 mr-6">
                                <div className="flex items-center gap-2 font-parismatch">
                                    <div>{name}</div>
                                </div>
                                <div className="text-lg text-yellow-300 flex items-center gap-2">
                                    {keybind && (
